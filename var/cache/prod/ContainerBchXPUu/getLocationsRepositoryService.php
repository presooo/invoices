...
// Returns the private 'App\Repository\LocationsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LocationsRepository.php';

return $this->privates['App\\Repository\\LocationsRepository'] = new \App\Repository\LocationsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
