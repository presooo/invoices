...
// Returns the private 'App\Repository\InvoiceHeadersRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InvoiceHeadersRepository.php';

return $this->privates['App\\Repository\\InvoiceHeadersRepository'] = new \App\Repository\InvoiceHeadersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
